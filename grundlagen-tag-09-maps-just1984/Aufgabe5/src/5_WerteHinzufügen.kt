fun main() {
    ...
    personPetMap.set("Tim", "Schildkröte")
    ...
    /*
        ...
        Das Paar Bernd -> Igel wird erstellt
        Was passiert, wenn du der MutableMap das Paar "Luis" -> "Mäuse" hinzufügst?
        Das Paar Luis -> Mäuse wird auch erstellt. Überschreibt jedoch das selbe schon vorhandene Paar. */

    personPetMap["Bernd"] = "Igel"
    personPetMap["Luis"] = "Mäuse"
    println(personPetMap)
